...
session.setAttribute("deleteNo", No); %>
   <div class="menu1">
    <ul>
  ...
  <div class="signup-form">
    <form action="deleteFI?No=${sessionScope.deleteNo}" method="post">
       <h1 align="center">删除前台操作员:<font>${sessionScope.deleteNo}</font>的信息</h1>
