...
<div class="menu1">
 ...
 <div class="signup-form">
      <form action="FICBylastnameServlet" method="post">
        <h1 align="center">请输入姓氏查询</h1>
         <input  type="text" placeholder="姓氏" name="lastname"  onfocus="clearMsg();" class="txtb">
         <span id=selectSpan>${requestScope.fstuffselect_msg}</span>
