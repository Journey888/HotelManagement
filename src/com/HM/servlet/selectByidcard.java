...
/**
 * Servlet implementation class selectByidcard
 */
public class selectByidcard extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public selectByidcard() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Client> b = a.selectByidcard(idcard);
		if(b.size()==0) {
			request.setAttribute("select_msg","该用户未入住过本酒店" );
			//获取转发器
			RequestDispatcher rd = request.getRequestDispatcher("selectByidcard.jsp");
			//开始转发
